        ...
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="organization">
              <ul class="nav flex-column align-items-center sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ url('/setting/company') }}"><i class="fa fa-circle-o"></i>{{ __('Company') }}</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('/setting/branches') }}"><i class="fa fa-circle-o"></i>{{ __('Branches') }}</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('/setting/departments') }}"><i class="fa fa-circle-o"></i>{{ __('Department') }}</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item">
            ...
            <div class="collapse" id="payroll_setting">
              <ul class="nav flex-column align-items-center sub-menu">
                <li class="nav-item">
                    <ul>
                        <li><a class="nav-link" href="{{ url('/setting/bank_lists') }}"><i class="fa fa-circle-o"></i>{{ __('Bank Listing') }}</a></li>
                        <li><a class="nav-link" href="{{ route('gl_interface_control_files.index') }}"><i class="fa fa-circle-o"></i>{{ __('GL Interface Setup') }}</a></li>
                        <li><a class="nav-link" href="{{ route('bsp_bank_transfer_setups.index') }}"><i class="fa fa-circle-o"></i>{{ __('BSP Bank Setup') }}</a></li>
                        <li><a class="nav-link" href="{{ route('anz_bank_transfer_setups.index') }}"><i class="fa fa-circle-o"></i>{{ __('ANZ Bank Setup') }}</a></li>
                        <li><a class="nav-link" href="{{ route('wpac_bank_transfer_setups.index') }}"><i class="fa fa-circle-o"></i>{{ __('WPAC Bank Setup') }}</a></li>
                        <li><a class="nav-link" href="{{ route('kina_bank_transfer_setups.index') }}"><i class="fa fa-circle-o"></i>{{ __('KINA Bank Setup') }}</a></li>
                        <li><a class="nav-link" href="{{ url('/setting/holidays') }}"><i class="fa fa-circle-o"></i>{{ __('Holiday List') }} </a></li>
                        <li><a class="nav-link" href="{{ url('/setting/working-days') }}"> <i class="fa fa-circle-o"></i>{{ __('Set Working Day') }}</a></li>
                        <li><a class="nav-link" href="{{ url('/setting/personal-events') }}"><i class="fa fa-circle-o"></i>{{ __('Personal Event') }} </a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="employees">
              <ul class="nav flex-column align-items-center sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{ url('/people/employees') }}"><i class="fa fa-circle-o"></i>{{ __('Employee List') }}</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{ url('hrm/loans') }}"><i class="fa fa-circle-o"></i>{{ __('Loans Applications') }}</a></li>
